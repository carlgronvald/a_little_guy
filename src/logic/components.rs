...
impl Collider {
    pub fn is_colliding(pos1 : &Position, col1 : &Collider, pos2 : &Position, col2 : &Collider, collision_meshes : &CollisionMeshManager) -> bool {
        let sz1 = col1.size;
        let sz2 = col2.size;
        ...
        col1.transform([pos1.x,pos1.y], sz1).is_colliding(&col2.transform([pos2.x, pos2.y], sz2))
    }
}